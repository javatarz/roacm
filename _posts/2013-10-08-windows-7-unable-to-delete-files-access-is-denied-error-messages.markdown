...
[![Error Checking option]({{ site.url }}/assets/images/posts/2013-10-08-windows-7-unable-to-delete-files-access-is-denied-error-messages/Error-Checking-option-223x300.png)]({{ site.url }}/assets/images/posts/2013-10-08-windows-7-unable-to-delete-files-access-is-denied-error-messages/Error-Checking-option.png)Right click on the drive, go to properties, open the "Tools" tab and under the error checking section, click "Check now". [  

]({{ site.url }}/assets/images/posts/2013-10-08-windows-7-unable-to-delete-files-access-is-denied-error-messages/Error-Checking-option.png)




[![check disk window]({{ site.url }}/assets/images/posts/2013-10-08-windows-7-unable-to-delete-files-access-is-denied-error-messages/check-disk-window.png)]({{ site.url }}/assets/images/posts/2013-10-08-windows-7-unable-to-delete-files-access-is-denied-error-messages/check-disk-window.png)
...
]({{ site.url }}/assets/images/posts/2013-10-08-windows-7-unable-to-delete-files-access-is-denied-error-messages/check-disk-window.png)
