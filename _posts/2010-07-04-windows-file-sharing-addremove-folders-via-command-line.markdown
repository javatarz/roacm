...
To remove a file/folder from share ![]({{ site.url }}/assets/images/posts/2010-07-04-windows-file-sharing-addremove-folders-via-command-line/Windows-File-Sharing-Blocked-by-administrator-300x156.png)and type the following command in an elevated instance of command  prompt:
