...
On a lazy Sunday afternoon when you've got nothing better to do, you either write [rather useless scripts]({% post_url 2009-12-06-clean-file-list-generation-with-powershell-script %}) or update them. I chose to do the latter.
